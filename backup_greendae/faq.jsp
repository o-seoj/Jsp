    ...
    <main>
        ...
        <div class="top-bar">
            <div class="top-bar-content">
                <img src="/test/images/ico-home.png" alt="홈">
    ...
    <section id="container"> 
        <div class="sidebar">
            ...
            <div class="sidebarMenu">
                <ul class="list">
                    <li class="item">
                        <a href="/test/academic/notice.do" class="itemText">공지사항</a>
                    </li>
                    <li class="item">
                        <a href="/test/academic/schedule.do" class="itemText">학사일정</a>
                    </li>
                    <li class="item">
                        <a href="/test/academic/enroll.do" class="itemText">수강신청</a>
                    </li>
                    <li class="item">
                        <a href="/test/academic/grade.do" class="itemText">성적</a>
                    </li>
                    <li class="item">
                        <a href="/test/academic/graduation.do" class="itemText">수료 및 졸업</a>
                    </li>
                    <li class="item">
                        <a href="/test/academic/faq.do" class="itemText">자주 묻는 질문</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="boardLower"> <!--본문(내용 영역)-->
					...
					<c:forEach var="cate" begin="1" end="3">
					    <div class="text-with-icon">
					        <img src="/test/images/bullet-h4.png" alt="icon" class="icon">
					        <span>
					            <c:choose>
