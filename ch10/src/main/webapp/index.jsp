...
<html>
	...
	<body>
		...
		<h4>Shop</h4>
		<a href="/ch10/shop/customer/list.do">Customer CURD</a>
		<a href="/ch10/shop/product/list.do">Product CURD</a>
		
		<h4>College</h4>
		<a href="/ch10/college/student/list.do">Student CURD</a>
		<a href="/ch10/college/course/list.do">Course CURD</a>
		
		<h4>Bank</h4>
		<a href="/ch10/bank/account/list.do">Account CURD</a>
		<a href="/ch10/bank/customer/list.do">Customer CURD</a>
		
		<h4>Library</h4>
		<a href="/ch10/library/member/list.do">Member CURD</a>
		<a href="/ch10/library/bookr/list.do">Book CURD</a>
